...
// 		  >
// 		  {categoryList.map((item,index)=>(
// 			<div key={index} className={`flex flex-col justify-center items-center bg-gray-100 p-2 m-2 rounded-b-lg grayscale hover:grayscale-0 cursor-pointer border-purple-400 ${selectedCategory==index
// 				  ?'grayscale-0 border-[1px]' 
// 			:null}`}
// 			onClick={()=>{setSelectedCategory(index); onCategoryChange(item.value)}}>
// 				<Image
